...
window.LYDModal = {
    ...
    init: function() {
        ...
        document.querySelectorAll('.core-modal-backdrop').forEach(backdrop => {
        ...
        document.addEventListener('keydown', (e) => {
            if (e.key === 'Escape') {
                document.querySelectorAll('.core-modal-backdrop.active').forEach(backdrop => {
                    const modalId = backdrop.id.replace('-backdrop', '');
                    this.close(modalId);
                });
            }
...
window.LYDToast = {
    ...
    init: function() {
        if (!this.container) {
            ...
            this.container.className = 'core-toast-container';
...
window.LYDButton = {
    init: function() {
        ...
        document.querySelectorAll('.core-button.loading').forEach(button => {
        ...
        document.querySelectorAll('.core-button:not(.loading):not(:disabled)').forEach(button => {
...
window.LYDDatePicker = {
    ...
    toggle: function(pickerId) {
        ...
        const calendar = picker?.querySelector('.core-datepicker-calendar');
        
        if (calendar) {
            // Close other calendars
            document.querySelectorAll('.core-datepicker-calendar.open').forEach(cal => {
    ...
    init: function() {
        ...
        document.addEventListener('click', (e) => {
            if (!e.target.closest('.core-datepicker')) {
                document.querySelectorAll('.core-datepicker-calendar.open').forEach(calendar => {
...
window.LYDUtilities = {
    ...
    init: function() {
        ...
        document.querySelectorAll('.core-button.copy, [data-clipboard]').forEach(button => {
