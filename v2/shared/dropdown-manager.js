...
class DropdownManager {
    ...
    setupDropdownHandlers() {
        ...
        const triggers = document.querySelectorAll(`
            .core-select-trigger,
            .core-dropdown-trigger,
            .core-autocomplete-trigger,
            .core-combobox-trigger,
            .core-datepicker-trigger
        `);
        ...
        triggers.forEach(trigger => {
            trigger.addEventListener('click', (e) => {
                ...
                const container = trigger.closest('.core-select, .core-dropdown, .core-autocomplete, .core-combobox, .core-datepicker');
        ...
        options.forEach(option => {
            option.addEventListener('click', (e) => {
                ...
                const dropdown = option.closest('.core-select-dropdown, .core-dropdown-menu, .core-autocomplete-dropdown');
                const container = option.closest('.core-select, .core-dropdown, .core-autocomplete');
    ...
    getDropdownForTrigger(trigger) {
        return trigger.nextElementSibling || 
               trigger.parentElement.querySelector('.core-select-dropdown, .core-dropdown-menu, .core-autocomplete-dropdown');
    }
    ...
    positionFixedDropdown(container, dropdown) {
        ...
        const trigger = container.querySelector('.core-select-trigger, .core-dropdown-trigger, .core-autocomplete-input');
        if (!trigger) return;
    ...
    closeDropdown(container, dropdown) {
        ...
        const trigger = container.querySelector('.core-select-trigger, .core-dropdown-trigger, .core-autocomplete-trigger');
    ...
    closeAllDropdowns() {
        this.activeDropdowns.forEach(container => {
            const dropdown = container.querySelector('.core-select-dropdown, .core-dropdown-menu, .core-autocomplete-dropdown');
            if (dropdown) {
                this.closeDropdown(container, dropdown);
            }
        });
    ...
    handleOptionSelection(option, container, dropdown) {
        const trigger = container.querySelector('.core-select-trigger, .core-dropdown-trigger, .core-autocomplete-trigger');
        const selectedText = trigger?.querySelector('.core-select-text, .core-dropdown-text, .core-autocomplete-text, span');
        ...
        if (option.classList.contains('multi')) {
            ...
            // Update counter text
            const selectedOptions = dropdown.querySelectorAll('.core-select-option.selected, .core-dropdown-item.selected');
            if (selectedText) {
        ...
        dropdown.querySelectorAll('.core-select-option, .core-dropdown-item, .core-autocomplete-option').forEach(opt => {
    ...
    setupGlobalClickHandler() {
        document.addEventListener('click', (e) => {
            ...
            if (!e.target.closest('.core-select, .core-dropdown, .core-autocomplete, .core-combobox, .core-datepicker')) {
                this.closeAllDropdowns();
            }
        });
