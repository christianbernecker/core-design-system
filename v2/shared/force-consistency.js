...
(function() {
  ...
  function applyConsistentStyling() {
    console.log('🎯 CORE Design System: Forcing consistent styling...');
  ...
  console.log('✅ CORE Design System: Consistent styling applied');
  }

  // CSS-Injection als Backup
  const style = document.createElement('style');
  style.textContent = `
    /* CORE Design System - Force Consistency */
