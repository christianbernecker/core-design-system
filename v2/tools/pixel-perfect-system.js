...
class PixelPerfectSystem {
    constructor() {
        this.browser = null;
        this.baseUrl = 'http://designsystem.core-design-system.vercel.app';
    ...
    generateSpecialFixes(cssComparison) {
        ...
        const buttonDeviations = cssComparison.deviations?.filter(d => d.selector.includes('core-button')) || [];
        if (buttonDeviations.length > 0) {
            specialFixes.push({
                type: 'template',
                description: 'Implementation Guide verwendet nicht-standard Button-Klassen',
                fix: 'Ersetze inline Button-Styles mit .core-button Klassen',
...
.core-button { 
    ...
    isCriticalProperty(selector, property) {
        const criticalCombinations = [
            ...
            { selector: '.core-button', properties: ['font-family', 'padding', 'font-weight'] },
    ...
    getFixPriority(deviation) {
        ...
        if (deviation.selector === '.core-button') return 7;
        return 5;
    }
